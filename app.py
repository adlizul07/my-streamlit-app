...
if df is not None:
    ...
    kw_col = st.text_input("Keyword Column", "Keyword Match")
    irr_col = st.text_input("Irrelevant Column", "Irrelevant Match")
